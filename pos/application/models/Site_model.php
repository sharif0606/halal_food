...
class Site_model extends CI_Model {
    public function get_details(){
		...
		if($query->num_rows()==0){
            ...
            $data['subcategory_init']=$query1->subcategory_init;
            $data['childcategory_init']=$query1->childcategory_init;
	...
	public function update_site(){
        ...
        $query2="update db_company set category_init='$category_init',subcategory_init='$subcategory_init',childcategory_init='$childcategory_init',item_init='$item_init',
