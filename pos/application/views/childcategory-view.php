...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search Items Childcategory</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>childcategory/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('add_childcategory'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('subcategory_name'); ?></th>
                  <th><?= $this->lang->line('childcategory_code'); ?></th>
                  <th><?= $this->lang->line('childcategory_name'); ?></th>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('childcategory/ajax_list')?>",
            "type": "POST",
...
<script src="<?php echo $theme_link; ?>js/childcategory.js"></script>
