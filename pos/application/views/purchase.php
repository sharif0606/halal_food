                     ...
                     <div class="box box-info " >
                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 <label for="purchase_status" class="col-sm-2 control-label hidden"><?= $this->lang->line('status'); ?> <label class="text-danger">*</label></label>
...
<!-- ./wrapper -->
<script src="<?php echo $theme_link; ?>js/purchase.js?id=<?= time() ?>"></script>
<script>
