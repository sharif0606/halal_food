          ...
          <div class="box box-info ">
            ...
            <form class="form-horizontal" id="payment-types-form" onkeypress="return event.keyCode != 13;">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    <label for="bank_cash" class="col-sm-2 control-label">Payment Type<label class="text-danger">*</label></label>
                    <div class="col-sm-4">
                        <select class="form-control input-sm" id="bank_cash" name="bank_cash" value="<?php print $bank_cash; ?>" >
                            <option value="1" <?= $bank_cash==1?"selected":"" ?>>Cash</option>
                            <option value="2" <?= $bank_cash==2?"selected":"" ?>>Bank</option>
                        </select>
                		<span id="payment_type_name_msg" style="display:none" class="text-danger"></span>
                    </div>
                </div>
