...
<div class="wrapper">
 ...
 <?php
	if(!isset($title)){
      $fslider_image=$title=$short_description=$link="";
	}
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Add/Update Footslider</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $base_url; ?>category/view"><?= $this->lang->line('footslider_list'); ?></a></li>
      ...
      <div class="row">
        ...
        <?= form_open('#', array('class' => 'form', 'id' => 'category-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                ...
                <div class="form-group">
                    <label for="image" class="col-sm-2 control-label"><?= $this->lang->line('fslider_image'); ?></label>
                    <div class="col-sm-4">
                        <input type="file" class="form-control" name="fslider_image">
                        <span id="fslider_image_msg" style="display:block;" class="text-danger">Max Width/Height: 1290px * 400px & Size: 1MB </span>
                        <?php if($fslider_image){ ?>
                            <a href="<?= base_url($fslider_image) ?>" target="_blank">
                                <img src="<?= base_url($fslider_image) ?>" alt="" width="50px">
                            </a>
                        <?php } ?>
                    </div>
                </div>
...
<script src="<?php echo $theme_link; ?>js/footslider.js"></script>
