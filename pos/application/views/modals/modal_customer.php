                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden" maxlength="10" class="form-control maxlength no_special_char_no_space " id="phone" name="phone" placeholder=""  >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control maxlength  " id="gstin" name="gstin" placeholder=""  >
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden"  class="form-control maxlength  " id="tax_number" name="tax_number" placeholder=""  >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden"  class="form-control maxlength  " id="tax_number" name="country" placeholder=""  >
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden"  class="form-control maxlength  " id="tax_number" name="state" placeholder=""  >
                         ...
                         <div class="col-md-4">
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" id="city" name="city" placeholder="" >
                            </div>
                          </div>
                        </div>
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="postcode" name="postcode" placeholder="" >
                              </div>
                            </div>
                          </div>
                        </div>
