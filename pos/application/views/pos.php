            ...
            <?php }else{ ?>
                <div class="col-md-4">
                    <div class="input-group date">
                       ...
                       <input type="text" class="form-control pull-right datepicker" id="sales_date" name="sales_date" readonly onkeyup="shift_cursor(event,'sales_status')" value="<?= date('d-m-Y');?>">
                    </div>
                    <span id="sales_date_msg" style="display:none" class="text-danger"></span>
                </div>
            <?php } ?>
                ...
                <div class="col-md-4">
                  ...
                  <!--<select class="form-control select2" id="warehouse_id" name="warehouse_id"  style="width: 100%;" onchange="get_details();refresh_sales();">
                      <?php
                         $query1="select * from db_warehouse where status=1 order by id";
                         $q1=$this->db->query($query1);
                         if($q1->num_rows($q1)>0){
                              foreach($q1->result() as $res1){
...
function get_details(){
  ...
  $.post("<?php echo $base_url; ?>pos/get_details",{id:$("#category_id").val(),warehouse_id:$("#warehouse_id").val()},function(result){
    $(".search_div").html('');
