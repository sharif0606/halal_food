...
<div class="wrapper">
 ...
 <?php
	if(!isset($childcategory_name)){
      $childcategory_code=$childcategory_name=$descriptions=$is_slied=$is_advertise=$image=$banner_image=$advertise_image="";
	}
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Add/Update Child Category</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $base_url; ?>category/view"><?= $this->lang->line('childcategories_list'); ?></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="childcategory-form" onkeypress="return event.keyCode != 13;">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
              <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>">
              <div class="box-body">
                  <div class="form-group">
                     <label for="subcategory_id" class="col-sm-2 control-label">Sub Category <span class="text-danger">*</span></label>
                     <div class="col-sm-4">
                        ...
                        <?php
                           ...
                           if($q1->num_rows($q1)>0)
                            {  echo '<option value="">-Select-</option>'; 
                                ...
                                echo "<option $selected value='".$res1->id."'>".$res1->subcategory_name."</option>";
                              }
                            }
                            else{
                               ?>
                  ...
                  <div class="form-group">
                    <label for="childcategory_name" class="col-sm-2 control-label"><?= $this->lang->line('childcategory_name'); ?><label class="text-danger">*</label></label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control input-sm" id="childcategory_name" name="childcategory_name" placeholder="" onkeyup="shift_cursor(event,'description')" value="<?= $childcategory_name; ?>" autofocus >
                        <span id="childcategory_name_msg" style="display:none" class="text-danger"></span>
                    </div>
                  </div>
                  <div class="form-group">
...
<script src="<?php echo $theme_link; ?>js/childcategory.js?id=<?= time() ?>"></script>
