...
<div class="row">
	<div class="col-xs-12 col-sm-6">
		...
		<button type="button" class="btn btn-success" onclick="get_details_report_day_wise()">Get Report (Daily By Date)</button>
	</div>
</div>
<hr>
...
function get_details_report(){
	...
	$.ajax({
        url: baseUrl+'report/loan_report/glrm',
        data:{
				'rMonth':rMonth,
				'rYear':rYear,
            }, 
...
function get_details_report_day(){
	...
	$.ajax({
        url: baseUrl+'report/loan_report/glrd',
        data:{
				'rMonth':rMonth,
				'rYear':rYear,
            }, 
...
function get_details_report_day_wise(){
	...
	$.ajax({
        url: baseUrl+'report/loan_report/glrbd',
        data:{
				'rMonth':rMonth,
				'rYear':rYear,
            }, 
