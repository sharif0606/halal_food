...
<div class="row">
	...
	<div class="col-xs-12">
		<div class="table-header">
			Results for "Loan Paid Amount Details Date Wise"
		</div>
		<div id="display">
				...
				<td class="center">
					...
					<td>
						<div class="hidden-sm hidden-xs action-buttons">	
							<?php if($d['status'] > 0) {?> 
							   <!--<button class="green" style="outline:none;border:none;" class="pull-right"  data-toggle="modal" data-target="#myModal" onclick="changeBalance('<?= $d['loan_No']; ?>',<?= $d['number_of_Payment'];?>,<?= $d['installment_Amount'];?>,'<?= $d['p_Status']; ?>',<?= $d['paid_Amount'];?>,<?= $d['status'];?>,<?= $d['id'];?>,'<?= $d['paid_Date'];?>')">
								<i class="ace-icon fa fa-pencil bigger-130"></i>
								</button>       			
								<a class="red" href="<?= base_url();?>loan/view_loan_assign_member_By_Id/clins?id=<?= $d['id'];?>&member_Id=<?= $d['member_Id'];?>&loan_No=<?= $d['loan_No'];?>"><i class="ace-icon fa fa-trash bigger-130"></i>
								</a>-->
						    <?php }?>
						</div>
					</td>
			...
			<tfoot>
				<tr>
					<th></th><th></th><th></th><th></th><th></th><th></th><th style="text-align:right">Sub Total</th><th colspan="4"></th>
				</tr>
				<tr>
					<th></th><th></th><th></th><th></th><th></th><th></th><th style="text-align:right">Total</th><th class="total"></th><th colspan="3"></th>
				</tr>
			</tfoot>
		   </table>
		  </div>
