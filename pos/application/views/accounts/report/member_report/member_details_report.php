...
<div class="row">
	...
	<div class="col-lg-12 col-sm-6">
		<button type="button" class="btn btn-primary" onclick="get_details_report()">Member Details Report</button>
	</div>
</div>
<hr>
<div class="row" id="details_data"></div>
<script type="text/javascript">
function get_details_report(){
	var rMonth=$('#current_month').val();
	var rYear=$('#current_year').val();
	$.ajax({
        url: baseUrl+'report/Member_details_report/mdr',
        data:{
				'rMonth':rMonth,
				'rYear':rYear,
            }, 
