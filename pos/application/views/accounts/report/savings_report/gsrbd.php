...
<div class="row">
	...
	<div class="col-xs-12">
		<div class="table-header">
			Results for "Long Term Savings Amount Details Date Wise"
		</div>
		<div id="display">
			...
			<?php foreach($data as $d){ ?>
				...
				<td class="center">
					...
					<td><?= $d['updated_on']; ?></td>
                                        ...
                                        <?php if($d['status'] > 0) {?> 
										<td>
                                                           <!--<button class="green" style="outline:none;border:none;" data-toggle="modal" data-target="#myModal" onclick="changeBalance('<?= $d['dps_No']; ?>',<?= $d['number_of_Payment'];?>,<?= $d['savings_Amount'];?>,'<?= $d['p_status']; ?>',<?= $d['paid_Amount'];?>,<?= $d['status'];?>,<?= $d['id'];?>,'<?= $d['paid_Date'];?>')">
											                <i class="ace-icon fa fa-pencil bigger-130"></i>
										                    </button>
													
														<a class="red" href="<?= base_url();?>dps/View_Dps_By_Id/cltsamt?id=<?= $d['id'];?>&member_Id=<?= $d['member_Id'];?>&dps_No=<?= $d['dps_No'];?>"><i class="ace-icon fa fa-trash bigger-130"></i></a>-->
														</td>
                                       <?php  } ?>
			...
			<tfoot>
				<tr>
					<th></th><th></th><th></th><th></th><th></th><th style="text-align:right">Sub Total</th><th></th><th colspan="4"></th>
				</tr>
				<tr>
					<th></th><th></th><th></th><th></th><th></th><th style="text-align:right">Total</th><th class="total"></th><th colspan="4"></th>
				</tr>
			</tfoot>
		   </table>
		  </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	<?php echo form_open_multipart('dps/View_Dps_By_Id/edit'); ?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">DPS Payment Update</h4>
      </div>
      <div class="modal-body">
		...
		<div class="form-group">
			<label>DPS No</label>
			<input type="text" id="dps_No" name="dps_No" class="form-control" readonly>
		...
		<div class="form-group">
			...
			<input type="text" id="savings_Amount" name="savings_Amount" class="form-control" readonly>
		</div>
		<div class="form-group">
