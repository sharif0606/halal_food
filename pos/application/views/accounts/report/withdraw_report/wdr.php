...
<div class="row">
	<div class="col-lg-12 col-sm-6">
		...
		<button type="button" class="btn btn-danger" onclick="get_details_report_rs_day_wise_withdraw()">Get Report Date Wise(RS WithDraw)</button>
...
function get_details_report_rs_day_wise_withdraw(){
	var rMonth=$('#current_month').val();
	var rYear=$('#current_year').val();

	$.ajax({
        url: baseUrl+'withdraw/Withdraw_paid_Bal/withdrawData',
