					...
					<div class="widget-content padding">
						...
						<div class="form-group" style="margin-bottom: 0px;">
							...
							<ul class="list-inline">
								<li><a href="<?= base_url('accounts/');?>accounts/credit_voucher_list" class="text-muted small">Receive Voucher List</a> </li> |
								<li><a href="<?= base_url('accounts/');?>accounts/credit_voucher_entry" class="text-muted small">Receive Voucher Create</a> </li>
							</ul>
							</div>
							
							<div class="col-sm-4"></div>
							<div class="col-sm-4" style="text-align:right;">
								<a href="<?php echo base_url();?>accounts/credit_voucher_print/<?php echo $vdata['id']; ?>" class="text-muted small">
								<img width='24' border='0' style='' title='Print' src='<?php echo base_url();?>assets/images/pdf.png'>
								</a>
							</div>
							</div>
						</div>
					<?= form_open('accounts/credit_voucher_edit/'.$vdata['id'],'id="detvoucherform" name="detvoucherform"'); ?>
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										<label>Voucher No:</label>
										<input type="text" class="form-control" name="voucher_no" id="voucher_no" value="<?= $vdata["voucher_no"];?>" readonly>
									</div>
									<div class="col-sm-4">
										<label>Date:</label>
										<?php 
							...
							<div class="form-group">
								<label>Pay By:</label>
								<input type="text" class="form-control" name="pay_name" id="pay_name" value="<?php echo $vdata["pay_name"];?>" required>
							</div>
								...
								<table class="table table-bordered" id='area' cellspacing="0" width="100%">
									...
									<tfoot>
										<tr>
											...
											<th>
												<?php echo $vdata["Amount"];?>
												<input type='text' name='id' value='<?php echo $vdata['id']; ?>' />
											</th>
										</tr>
									</tfoot>
