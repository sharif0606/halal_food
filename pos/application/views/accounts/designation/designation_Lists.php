...
<div class="row">
									<div class="col-xs-12">
										...
										<div class="clearfix">
											...
											<a href="<?= base_url();?>designation/Designation" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold" ><i class="fa fa-plus bigger-110 grey"></i> <span class="">Add Designation</span></a>
		...
		if($designation_Lists){
			foreach($designation_Lists as $row){ ?>
		<tr>
			...
			<td><?php if($row['status'] == 1) echo '<button class="btn btn-white btn-success">Active</button>'; else echo '<button class="btn btn-white btn-danger">Inactive</button>';?></td>

			
							<td class="aHide">
							<div class="hidden-sm hidden-xs action-buttons">
										
																<a class="blue" href="<?= base_url();?>designation/Designation/edit?id=<?= $row['id'];?>">
															...
															<td>
															<a class="blue" href="designation/Designation/inactive?id=<?= $row['id'];?>&status=<?= $row['status'];?>">
															<?php if($row['status'] == 1){ ?>
																	<i class="ace-icon fa fa-trash-o bigger-130" class="red">Click To Inactive</i>
																<?php } else {?>
																	<i class="ace-icon fa fa-check-square-o bigger-130" class="green">Click To Active</i>
																<?php } ?>
															</a>
															</td>
		</tr>
