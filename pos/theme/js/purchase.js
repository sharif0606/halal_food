...
$('#save,#update').click(function (e) {
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    var this_id=this.id;
        ...
        //console.log(base_url+'purchase/db_itemsdb_itemsdb_items?command='+this_id+'&rowcount='+rowcount+'&tot_subtotal_amt='+tot_subtotal_amt+'&tot_discount_to_all_amt='+tot_discount_to_all_amt+'&tot_round_off_amt='+tot_round_off_amt+'&tot_total_amt='+tot_total_amt+"&other_charges_amt="+other_charges_amt);
        //return false;
